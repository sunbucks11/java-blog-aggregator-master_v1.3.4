    ...
    .controller('BaseFormCtrl', ['$scope', '$http', function ($scope, $http) {
        ...
        $scope.login = function (username, password) {
            ...
            .then(function(response) {
                if (response.data == 'ok') {
//                    window.location.replace('../../resources/pages/calories-tracker.html');
                	 /*window.location.replace('../../resources/pages/spa/user-management.jsp');*/
                	  window.location.replace('../../resources/pages/admin/home-admin.jsp');
                }
                else {
