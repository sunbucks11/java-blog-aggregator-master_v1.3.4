                ...
                <div class="bootstrap-dialog-body">
                    ...
                    <form field="form" name="fieldForm" novalidate="" ng-submit="ctrl.submit()">
                        ...
                        <div class="form-group ">
                            ...
                            <input type="text " class="input-xlarge form-control " id="field-name " placeholder="Enter field name " required=" " ng-bind="ctrl.field.name " data-ng-model="ctrl.field.name " style="color: black " maxlength="64 " />
