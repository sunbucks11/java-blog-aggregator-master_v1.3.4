<div class="modal fade" id="removeFieldModel" field="dialog">
      ...
      <div class="modal-content">
         ...
         <div class="modal-header bootstrap-dialog-draggable">
            <div class="bootstrap-dialog-header">
               ...
               <h4 class="modal-title" id="myModalLabel">Remove field</h4>
            </div>
         </div>
         <!-- =============  Body ==============-->
                     ...
                     <div class="panel panel-default">
                        <div class="tablecontainer">
                           <table class="table table-hover">
                              <tbody>
                                 <tr ng-repeat="r in ctrl.fields track by r.id">
                                    <td><span ng-bind="r.id"></span></td>
                                    <td><span ng-bind="r.name"></span></td>
                                   
                                   
<!--                                     <td>
                                       <div style="display: inline;" ng-repeat="r in u.fields">
